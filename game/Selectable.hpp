...
{
public:
    LeaderBoardSelectable( bool enabled,
                           const BoundingBox &r, 
...
{
public:
    TextOnlySelectable( bool enabled,
                        const BoundingBox &r, 
                        const std::string &text,
                        const std::string &info, 
                        bool center=true,
...
class ResolutionSelectable:public TextOnlySelectable
{
    struct Resolution
    {
	Resolution( int w, int h):width(w), height(h), text()
        {
            char buf[32];
            sprintf( buf, "%dx%d", w, h);
            text = buf;
        }
	Resolution( int w, int h, std::string t):width(w), height(h), text(t) {}
        Resolution( const Resolution& r):width(r.width), height(r.height), text(r.text) {}
    ...
    static bool DescendingAreaOrder( const Resolution &res1, 
                                     const Resolution &res2);    
    
public:
    ResolutionSelectable( bool enabled,
                          const BoundingBox &r, 
                          const std::string &text,
                          const std::string &info);
...
{
public:
    FloatSelectable( bool enabled,
                     const BoundingBox &r, 
                     const std::string &text,
                     const std::string &info, 
                     const std::string &variable,
                     const std::string &range,
                     const std::string &sliderOffset);
...
{
public:
    BindKeySelectable( bool enabled,
                       const BoundingBox &r, 
                       const std::string &text,
                       const std::string &info, 
                       const std::string &action, 
